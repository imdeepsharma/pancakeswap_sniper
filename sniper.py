...
# pancakeswap factory address and abi = pancakeswap factory
...
contract = web3.eth.contract(
    address=pancakeswap_factory, abi=pancakeswap_factory_abi)
...
sender_address = web3.toChecksumAddress(
    '0x04766Ae23dc71Fb427CB2a0574E6EE967e5554F3')  # the address which buys the token taken from https://vanity-eth.tk/
tokenToBuy = web3.toChecksumAddress(
    '0xebca5a64432660dc7aac05d52315b0583734151b')  # Some shit token in BSC pancakeswap to buy
tokenToSell = web3.toChecksumAddress(
    '0xebca5a64432660dc7aac05d52315b0583734151b')  # Some shit token in BSC pancakeswap to sell
...
def buy():
    ...
    signed_txn = web3.eth.account.sign_transaction(
        ...
        pancakeswap2_txn, private_key="63d4b5bda397ce6150aad5e035241b50a70d7283f6402da849af7315aa2f909e")
...
def sell():
    ...
    signed_txn = web3.eth.account.sign_transaction(
        # private key of the address which buys the token taken from https://vanity-eth.tk/
        approve, private_key="63d4b5bda397ce6150aad5e035241b50a70d7283f6402da849af7315aa2f909e")
    tx_token = web3.eth.send_raw_transaction(signed_txn.rawTransaction)
...
# when main is called
# create a filter for the latest block and look for the "PairCreated" event for the pancakeswap factory contract
# run an async loop
